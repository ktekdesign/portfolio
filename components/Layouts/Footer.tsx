...
const Footer = () => (
  <Container className="footer-area footer-dark" as="footer">
    ...
    <Link data-aos="fade-up" data-aos-duration="1200" className="link_whatsapp" target="_blank" href="https://api.whatsapp.com/send?phone=5541997527702"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">

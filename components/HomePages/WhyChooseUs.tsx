        ...
        <div className="col-lg-7 col-md-12">
          ...
          >
            ...
            <div className="about-text">
              ...
              <p>
                Nous avons contribué à la croissance de plusieurs entreprises au
                plan continental ainsi qu&apos;à l&apos;international. Notre
                équipe est lidérée par&nbsp;
                <Link
                ...
                startups dont la capitalisation surpasse le milliard de dollars.
              </p>
            </div>
            ...
            <div className="about-text">
              ...
              <p>
                En 8 ans d&apos;activité, nous avons developpé plusieurs grands
                projets en Afrique dont les applications web et Android
                TchadCarriere qui totalisent plus 25.000 téléchargements dans la
                PlayStore et plus de 500.000 visites par mois sur le site. Notre
                savoir-faire et notre réputation ne sont plus à démontrer auprès
                de nos clients qui sont satisfaits de nos services.
              </p>
              <p>
            ...
            <div className="about-text">
              ...
              <p>
                ...
                compliqué que ce qui est décrit par les influenceurs. Vous avez

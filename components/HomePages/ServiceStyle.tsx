...
const ServiceStyle = () => (
  <>
    <Container className="service-style-two ptb-100 bg-fcfbfb">
    ...
    <Container className="service-style-two ptb-100">
      <div className="row align-items-center">
        <div className="col-lg-6">
          <div
        ...
        <div className="col-lg-6">
          <div className="service-info pr-50">
            <div className="info-head">
              ...
              <p>
                Prenez controle du Cloud pour fournir une haute disponibilité de
                vos applications.
              </p>
              <p>

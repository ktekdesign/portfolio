export const servicesData = {
  ...
  app_dev: {
    ...
    description:
      "<p>Vous cherchez à développer une application mobile pour Android ou iOS ? Nous sommes là pour vous aider !</p> \
  ...
  web_hosting: {
    ...
    description:
      "<p>Vous cherchez un hébergement web fiable pour votre site ou votre application en ligne ? Nous avons la solution pour vous ! </p> \
